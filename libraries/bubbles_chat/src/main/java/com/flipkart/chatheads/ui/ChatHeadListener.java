...
public interface ChatHeadListener<T> {
    ...
    <T extends Serializable> void onChatHeadAnimateStart(ChatHead<T> chatHead);
    Boolean onBackPress(T key);
    void onJoinBubble(T key);
    void onChangeBubble(T oldKey, T newKey);
}
