...
public class MinimizedArrangement<T extends Serializable> extends ChatHeadArrangement {
    ...
    private final SpringListener horizontalHeroListener = new SimpleSpringListener() {
        @Override
    ...
    private final SpringListener verticalHeroListener = new SimpleSpringListener() {
        @Override
        public void onSpringUpdate(Spring spring) {
...
//            hero.getVerticalSpring().removeListener(verticalHeroListener);
    ...
    private Bundle getBundle(int heroIndex) {
        if(hero!=null && hero.getHorizontalSpring() != null && hero.getVerticalSpring() != null){
            relativeXPosition = (hero.getHorizontalSpring().getCurrentValue()) / maxWidth;
            relativeYPosition = hero.getVerticalSpring().getCurrentValue() / maxHeight;
        }
