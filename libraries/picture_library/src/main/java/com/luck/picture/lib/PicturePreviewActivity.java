...
public class PicturePreviewActivity extends PictureBaseActivity implements
    ...
    protected LinearLayout lnPictureChoose;
    /**
     * 是否已完成选择
     */
    ...
    protected void initWidgets() {
        ...
        lnPictureChoose = findViewById(R.id.lnPictureChoose);
        ...
        lnPictureChoose.setOnClickListener(this);
...
//                    lnPictureChoose.setBackgroundTintList(colorStateList);
                }
            }
...
//                lnPictureChoose.setBackgroundColor(PictureSelectionConfig.style.pictureUnCompleteTextColor);
...
//                lnPictureChoose.setBackgroundTintList(completeColorStateList);
            }
...
//                    lnPictureChoose.setBackgroundColor(PictureSelectionConfig.style.pictureCompleteTextColor);
                } else {
                    mTvPictureOk.setTextColor(ContextCompat.getColor(getContext(), R.color.picture_color_fa632d));
//                    lnPictureChoose.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.picture_color_fa632d));
                }
            }
            if (numComplete) {
...
//                    lnPictureChoose.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.picture_color_9b));
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.pictureLeftBack) {
            onBackPressed();
        } else if (id == R.id.lnPictureChoose || id == R.id.tv_media_num) {
            onComplete();
