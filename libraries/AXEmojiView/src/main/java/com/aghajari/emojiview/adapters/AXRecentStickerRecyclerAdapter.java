...
public class AXRecentStickerRecyclerAdapter extends RecyclerView.Adapter<AXRecentStickerRecyclerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(cw, cw);
        params.gravity = Gravity.CENTER;
        frameLayout.addView(pbLoading, params);
        int dp32 = Utils.dpToPx(viewGroup.getContext(), 32);
        pbLoading.setPadding(dp32, dp32, dp32, dp32);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        final View pbLoading = (View) frameLayout.getChildAt(1);
        View ripple = (View) frameLayout.getChildAt(2);


        @SuppressWarnings("rawtypes") final Sticker sticker = (Sticker) recent.getRecentStickers().toArray()[i];
        loader.onLoadSticker(stickerView, pbLoading, sticker);
