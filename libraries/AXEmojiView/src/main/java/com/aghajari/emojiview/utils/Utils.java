...
public class Utils {
    ...
    public static ContextWrapper asContextWrapper(@NonNull final Context context) {
        if(context instanceof ContextWrapper){
            return (ContextWrapper) context;
        }
        throw new IllegalArgumentException("The passed Context is not an ContextWrapper.");
    }
