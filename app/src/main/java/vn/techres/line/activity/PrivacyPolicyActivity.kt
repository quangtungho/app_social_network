...
import vn.techres.line.databinding.ActivityPrivacyPolicyBinding
    ...
    override fun onSetBodyView() {
        ...
        binding.wvPrivacyPolicy.apply {
            ...
            addJavascriptInterface(
                WebAppInterface(this@PrivacyPolicyActivity),
                "AndroidShareHandler"
            )

            loadUrl(urlWebView)
            setOnKeyListener { _, keyCode, event ->
                if (keyCode == KeyEvent.KEYCODE_BACK && event.action == MotionEvent.ACTION_UP && binding.wvPrivacyPolicy.canGoBack()) {
                    binding.wvPrivacyPolicy.goBack()
        ...
        binding.imgShare.setOnClickListener {
            ...
            val shareBody =
                "Application Link : ${TechresEnum.PRIVACY_POLICY_URL}"
