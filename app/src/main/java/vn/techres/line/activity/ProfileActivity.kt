...
import vn.techres.line.data.model.eventbus.*
...
import vn.techres.line.databinding.ActivityProfileBinding
...
class ProfileActivity : BaseBindingActivity<ActivityProfileBinding>(),
    ...
    override fun onSetBodyView() {
        ...
        intent?.let {
            idProfile = if (it.getStringExtra(TechresEnum.ID_USER.toString()).isNullOrEmpty()){
                it.getIntExtra(TechresEnum.ID_USER.toString(), 0)
            }else{
                it.getStringExtra(TechresEnum.ID_USER.toString())!!.toString().toInt()
            }
        }
                ...
                .subscribe(object : Observer<BaseResponse> {
                    ...
                    override fun onNext(response: BaseResponse) {
                        if (response.status != AppConfig.SUCCESS_CODE) {
                            ...
                            EventBus.getDefault().post(EventBusChangeStatusFriend(2, profile.id))
                        }
                    }
                })
        }
                ...
                .subscribe(object : Observer<BaseResponse> {
                    ...
                    override fun onNext(response: BaseResponse) {
                        if(response.status == 200 ){
                            EventBus.getDefault().post(EventBusChangeStatusFriend(4, profile.id))
                        }
                    }
                })
        }
                ...
                .subscribe(object : Observer<BaseResponse> {
                    ...
                    override fun onNext(response: BaseResponse) {
                        if (response.status != AppConfig.SUCCESS_CODE) {
                            ...
                            EventBus.getDefault().post(EventBusChangeStatusFriend(1, profile.id))
                        }
                    }
                })
        }
    ...
    override fun clickEditProfile() {
        supportFragmentManager.commit {
            ...
            add<EditProfileFragment>(R.id.frameProfile, null)
    ...
    override fun clickMediaImage() {
        ...
        supportFragmentManager.commit {
            ...
            add<ProfileImageFragment>(R.id.frameProfile, args = bundle)
    ...
    override fun clickMediaVideo() {
        ...
        supportFragmentManager.commit {
            ...
            add<ProfileVideoFragment>(R.id.frameProfile, args = bundle)
    ...
    override fun clickMediaAlbum() {
        ...
        supportFragmentManager.commit {
            ...
            add<ProfileAlbumFragment>(R.id.frameProfile, args = bundle)
    ...
    private fun createReportUser(content: String) {
        ...
        ServiceFactory.createRetrofitService(
            ...
            .subscribe(object : Observer<BaseResponse> {
                ...
                override fun onNext(response: BaseResponse) {
                    Toast.makeText(this@ProfileActivity, "Báo cáo thành công", Toast.LENGTH_SHORT).show()
                }
            })
    }
...
//        createReviewCommentRestaurant(position, idComment, content)
    ...
    @Subscribe
    fun onRefresh(event: EventBusRefresh) {
        WriteLog.d("Đã refresh ", "nha")
        getProfile(idProfile)
        checkStatusProfile()
        getListFriend(idProfile)
    }
