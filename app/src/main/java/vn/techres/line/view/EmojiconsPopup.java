...
import vn.techres.line.helper.emoji.Nature;
import vn.techres.line.helper.emoji.Objects;
import vn.techres.line.helper.emoji.People;
import vn.techres.line.helper.emoji.PlacesEmojicon;
import vn.techres.line.helper.emoji.Symbols;
import vn.techres.line.helper.emoji.Emojicon;
import vn.techres.line.helper.emoji.Nature;
import vn.techres.line.helper.emoji.Objects;
import vn.techres.line.helper.emoji.People;
...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
    ...
    public void showAtBottomPending() {
        if (java.util.Objects.equals(Boolean.TRUE, isKeyBoardOpen()))
            showAtBottom();
        else
            pendingOpen = true;
    }
    ...
    public void setSizeForSoftKeyboard() {
        rootView.getViewTreeObserver().addOnGlobalLayoutListener(() -> {
            ...
            if (heightDifference > 100) {
                ...
                isOpened = true;
                if (Boolean.TRUE.equals(pendingOpen)) {
                    showAtBottom();
                    pendingOpen = false;
                }
            } else {
    ...
    private View createCustomView() {
        ...
        mEmojisAdapter = new EmojisPagerAdapter(
                Arrays.asList(
                        ...
                        new EmojiconGridView(mContext, PlacesEmojicon.DATA, recents, this),
        ...
        view.findViewById(R.id.emojis_backspace).setOnTouchListener(new RepeatListener(1000, 50, v -> {
