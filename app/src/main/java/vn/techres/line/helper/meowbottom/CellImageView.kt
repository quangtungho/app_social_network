...
//                background = getColor(R.styleable.CellImageView_meow_imageview_background, background)
...
//                setImageDrawable(drawable)
        ...
        if(color != 0){
            setImageDrawable(DrawableHelper.changeColorDrawableVector(context, resource, color))
        }else{
            setImageResource(resource)
        }
    }
