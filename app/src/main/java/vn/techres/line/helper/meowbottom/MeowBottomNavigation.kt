...
package vn.techres.line.helper.meowbottom
...
//    private var selectedIconColor = Color.parseColor("#2196f3")
    ...
    private var countBackgroundColor = Color.parseColor("#d0021b")
...
//                defaultIconColor = getColor(R.styleable.MeowBottomNavigation_mbn_defaultIconColor, defaultIconColor)
    ...
    fun add(model: Model) {
        ...
        cell.apply {
            ...
            defaultIconColor = model.defaultIconColor
    ...
    class Model(var id: Int, var icon: Int, var defaultIconColor : Int, var selectedIconColor : Int) {
