...
public class AudioManager {
  ...
  private class WiredHeadsetReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      Timber.d("WiredHeadsetReceiver.onReceive" + AppRTCUtils.getThreadInfo() + ": "
...
// or removes his hand from the device.
    proximitySensor = ProximitySensor.create(context, () -> onProximitySensorChangedState());
...
// logging for now.
  ...
  public void updateAudioDeviceState() {
    ...
    if (bluetoothManager.getState() == BluetoothManager.State.HEADSET_AVAILABLE
        || bluetoothManager.getState() == BluetoothManager.State.SCO_CONNECTING
        || bluetoothManager.getState() == BluetoothManager.State.SCO_CONNECTED) {
      Timber.d("Need BT audio: start=" + needBluetoothAudioStart + ", "
