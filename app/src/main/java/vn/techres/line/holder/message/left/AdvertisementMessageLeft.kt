...
import vn.techres.line.databinding.ItemAdvertisementMessageLeftBinding
...
class AdvertisementMessageLeft(var binding : ItemAdvertisementMessageLeftBinding) : RecyclerView.ViewHolder(binding.root) {
    fun bind(
        context: Context,
        position: Int,
