...
import vn.techres.line.databinding.ItemReplyInfomationLeftBinding
...
class ReplyInformationLeftHolder(private val binding : ItemReplyInfomationLeftBinding) : RecyclerView.ViewHolder(binding.root){
    fun bind(
        context : Context,
