...
import vn.techres.line.databinding.ItemInviteEventCardLeftChatBinding
...
class InviteEventMessageLeftHolder (private val binding : ItemInviteEventCardLeftChatBinding) : RecyclerView.ViewHolder(binding.root) {
    fun bind(context : Context, configNodeJs : ConfigNodeJs, dataSource: ArrayList<MessagesByGroup>, position : Int, chatGroupHandler: ChatGroupHandler?){
...
//        )
        ...
        binding.inviteCard.txtOpenCard.text = "Mở Thiệp"
        /**
...
//        ChatUtils.setViewTimeLeft(binding.reaction.lnReaction, binding.rltInviteCard)
