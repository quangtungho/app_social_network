...
import vn.techres.line.databinding.FragmentVoucherUsedBinding
...
class VoucherUsedFragment : BaseBindingFragment<FragmentVoucherUsedBinding>(
    FragmentVoucherUsedBinding::inflate), VoucherHandler {
