...
public class AppRTCBluetoothManager {
    ...
    private class BluetoothHeadsetBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED)) {
                ...
                Timber.d("BluetoothHeadsetBroadcastReceiver.onReceive: "
    ...
    static AppRTCBluetoothManager create(Context context, AppRTCAudioManager audioManager) {
        Timber.d("create%s", AppRTCUtils.getThreadInfo());
    ...
    public void start() {
        ...
        Timber.d("HEADSET profile state: %s", stateToString(bluetoothAdapter.getProfileConnectionState(BluetoothProfile.HEADSET)));
    ...
    public boolean startScoAudio() {
        ThreadUtils.checkIsOnMainThread();
        Timber.d("startSco: BT state=" + bluetoothState + ", "
        ...
        Objects.requireNonNull(audioManager).startBluetoothSco();
        audioManager.setBluetoothScoOn(true);
        scoConnectionAttempts++;
        startTimer();
        Timber.d("startScoAudio done: BT state=" + bluetoothState + ", "
                + "SCO is on: " + isScoOn());
        return true;
    }
    ...
    public void stopScoAudio() {
        ThreadUtils.checkIsOnMainThread();
        Timber.d("stopScoAudio: BT state=" + bluetoothState + ", "
                + "SCO is on: " + isScoOn());
        ...
        Timber.d("stopScoAudio done: BT state=" + bluetoothState + ", "
                + "SCO is on: " + isScoOn());
    }
    ...
    public void updateDevice() {
        ...
        if (devices.isEmpty()) {
            ...
            Timber.d("Connected bluetooth headset: "
    ...
    protected void logBluetoothAdapterInfo(BluetoothAdapter localAdapter) {
        ...
        if (!pairedDevices.isEmpty()) {
            ...
            for (BluetoothDevice device : pairedDevices) {
                Timber.d(" name=" + device.getName() + ", address=" + device.getAddress());
            }
        }
    }
    ...
    private void bluetoothTimeout() {
        ...
        Timber.d("bluetoothTimeout: BT state=" + bluetoothState + ", "
                + "attempts: " + scoConnectionAttempts + ", "
                + "SCO is on: " + isScoOn());
        if (bluetoothState != State.SCO_CONNECTING) {
            return;
        ...
        if (!devices.isEmpty()) {
            ...
            if (bluetoothHeadset.isAudioConnected(bluetoothDevice)) {
                Timber.d("SCO connected with " + bluetoothDevice.getName());
                scoConnected = true;
            } else {
                Timber.d("SCO is not connected with " + bluetoothDevice.getName());
            }
        }
        if (scoConnected) {
