...
class FriendNewAdapter(val context: Context) :
    RecyclerView.Adapter<FriendNewAdapter.ItemHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        with(holder) {
            binding.lnFriendNew.visibility = View.VISIBLE
            ...
            binding.imgChat.setOnClickListener {
                clickFriendHandler!!.clickFriendChat(position, "friend_new")
            }
