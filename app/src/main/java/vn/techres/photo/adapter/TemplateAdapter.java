...
public class TemplateAdapter extends RecyclerView.Adapter<TemplateViewHolder> {
    ...
    public void onBindViewHolder(TemplateViewHolder holder, int position) {
        ...
        if (isPip) {
            lp.setColumnWidth(mContext.getResources().getDimensionPixelSize(R.dimen.size_76));
        }else {
            lp.setColumnWidth(mContext.getResources().getDimensionPixelSize(R.dimen.size_96));
        }
