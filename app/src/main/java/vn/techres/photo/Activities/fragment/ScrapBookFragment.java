package vn.techres.photo.Activities.fragment;
...
import vn.techres.photo.adapter.ScrapBGAdapter;
import vn.techres.photo.adapter.ScrapStickerAdapter;
import vn.techres.photo.appconfig.AppConstant;
import vn.techres.photo.appconfig.Logger;
import vn.techres.photo.listener.OnChooseColorListener;
import vn.techres.photo.multitouch.controller.ImageEntity;
import vn.techres.photo.multitouch.controller.MultiTouchEntity;
import vn.techres.photo.multitouch.controller.TextEntity;
import vn.techres.photo.multitouch.custom.OnDoubleClickListener;
import vn.techres.photo.multitouch.custom.PhotoView;
import vn.techres.photo.quickaction.QuickAction;
import vn.techres.photo.quickaction.QuickActionItem;
import vn.techres.photo.utils.DateTimeUtils;
import vn.techres.photo.utils.DialogUtils;
import vn.techres.photo.utils.ImageUtils;
import vn.techres.photo.utils.PhotoUtils;
import vn.techres.photo.utils.ResultContainer;
...
//        //by clicking the area outside the dialog.
        mTextQuickAction.setOnDismissListener((QuickAction.OnDismissListener) () -> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ratio.setOnClickListener(v -> clickDeleteCurrentPhotoView());

        save = rootView.findViewById(R.id.save);
        save.setOnClickListener(v -> clickShareView());
