...
import vn.techres.photo.adapter.FontAdapter;
import vn.techres.photo.colorpicker.ColorPickerDialog;
import vn.techres.photo.listener.OnChooseColorListener;
import vn.techres.photo.model.FontItem;
import vn.techres.photo.utils.TextUtils;
...
public class AddTextItemActivity extends BaseFragmentActivity implements OnChooseColorListener, ColorPickerDialog.OnColorChangedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEditText = (EditText) findViewById(R.id.svRestaurantCard);
        //In case edit text
