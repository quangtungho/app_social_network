...
import vn.techres.photo.Activities.custom.DoubleClickDetector;
import vn.techres.photo.frame.FrameTouch;
import vn.techres.photo.listener.OnFrameTouchListener;
import vn.techres.photo.multitouch.controller.ImageEntity;
import vn.techres.photo.multitouch.controller.MultiTouchController;
...
public class PhotoView extends View implements
    ...
    private void init(Context context) {
        ...
        this.displayHeight = res.getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? Math
                ...
                metrics.widthPixels, metrics.heightPixels);
        // photocollage
        mTouchAreaInterval = res.getDimension(R.dimen.size_10);
